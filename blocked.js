...
function returnSingleLessonPlanHTML() {
  var html = [
    '<h1>Hey there!</h1>',
    '<p>It looks like youâ€™ve reached a website your teacher doesnâ€™t want you to browse right now.</p>',
...
function returnMultiLessonPlanHTML(sessionJSON) {
  var html = [
    '<h1>Youâ€™re popular!</h1>',
    '<p>It looks like youâ€™re currently enrolled in multiple classroom sessions, which may limit which websites you can visit.</p>',
    '<p>Youâ€™re currently enrolled in:</p>',
  ];
  var classes = [];
